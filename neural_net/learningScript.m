...
TTest= T_r(:,401:end);
%%
miaNet=newNet(size(XTrain,1),M,size(TTrain,1));
[err,nuovaMiaNet]=miaLearningPhase(miaNet,MAX_EPOCHES,XTrain,TTrain,XVal,TVal,@derivFunActSigmoide,@derivFunActSigmoide, @derivCrossEntropyMC);