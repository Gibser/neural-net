...
net = net_conv_FC(layers2, {@relu, @softmax}, {@reluDeriv, @softmaxDeriv}, 3);
[err, final_net, err_val] = learningPhase_convFC(net, EPOCHE, XT, YT, XV, YV', @crossentropy, @crossentropyDeriv, 2, ETA, MOMENTUM, 128);
